...
just reindex --media-id <media_id> --transcript-path /path/to/file_transcribe.json
```

!!! info "CLI Documentation"
    For detailed CLI usage and additional import options, see the [CLI Documentation](../userguide/commandline.md).
