...
def solr_update_speakers(s3_prefix, speakers):
...
def solr_update_segment(s3_prefix, segment_nr, subtitles, subtitle_type):
...
def solr_search(solr_request: SolrRequest):
